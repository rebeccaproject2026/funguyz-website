        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between border-b border-purple-100/40 pb-6">
          ...
          <div className="flex gap-2 overflow-x-auto scrollbar-none pb-2 md:pb-0 flex-nowrap -mx-4 px-4 md:mx-0 md:px-0">
            {categoryTabs.map(tab => (
              <button
                ...
                className={`rounded-full px-5 py-2 text-xs font-bold uppercase tracking-widest transition-all duration-300 cursor-pointer shrink-0 border ${
          ...
          <div className="flex items-center gap-3 w-full md:w-auto shrink-0 justify-between md:justify-end">
            <button
              ...
              className={`flex-1 md:flex-initial flex items-center justify-center gap-2 border rounded-2xl px-4 py-2.5 text-xs font-bold transition-all duration-300 cursor-pointer ${
                isFilterPanelOpen
                    ...
                    {categoryTabs.map(tab => {
                      ...
                      return (
                        <button
                          ...
                          className={`text-left text-xs font-bold px-3.5 py-2.5 rounded-xl border transition-all cursor-pointer flex items-center justify-between ${
                            isActive
